...
public plugin_init()
{
	...
	gCVARFreeForAll = get_cvar_pointer( "mp_freeforall" )
...
public client_authorized( id )
{
	...
	if ( gCVARFreeForAll )
	{
		if ( get_pcvar_num( gCVARFreeForAll ) )
			return
	}
...
public Native_set_atac_attacks()
{
	...
	if ( is_user_connected( attacker ) )
	{
		...
		if ( amount != 0 )
		{
			new team1 = fm_get_user_team( attacker )
			new team2 = fm_get_user_team( victim )
